...
$contentTypeMapping = @{
    ...
    "AutomationRule"=@("Microsoft.OperationalInsights/workspaces/providers/Microsoft.SecurityInsights/automationRules", "Microsoft.SecurityInsights/automationRules");
